...
to load data into or retrieve data from the Teradata Vantage.
...
Framework Core Provider. The Entity Framework Core Provider will be available 
...
Client Operating Environment:
    ...
    Microsoft .NET Core 2.0           Windows, Linux, macOS
...
the file:
     ...
     tdnetdp__windows_indep.16.20.08.00.exe
...
refers to
     ...
     .NET Data Provider for Teradata 16.20.08.00
