...
namespace WebAPI.Controllers
{
    ...
    { 
        ...
        {          
            var objResConsultarMenu = client.consultaPerfilesUsuarioAppl(new WebAPI.perfiles.Input {  s3=  new s3 { datosPeticion = new datosPeticion() { aplicacion = prmAplicacion, usuario = prmUsuario } } });
