...
export class LoginComponent {
  ...
  login(): void {
    ...
    this._loginService.GetMenuS3(this.jmenu).subscribe((menus: any) => {
      this.menus = menus.menu.Childs;

      let menuCipher = this._cryptoService.encryptText(JSON.stringify(this.menus));
      ...
      /*
            this._loginService.MenuGetByUser(this.username).subscribe((menus: any) => {
              this.menus = menus.menu.Childs;
