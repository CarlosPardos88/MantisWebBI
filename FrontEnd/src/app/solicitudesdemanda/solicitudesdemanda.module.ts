...
import { solicitudesRoutes } from './solicitudesdemanda.routes';
import { SharedModule } from '../commons/shared.module';
import { CovalentMenuModule, CovalentNotificationsModule } from '@covalent/core';

import { SOLICITUDDEM_PROVIDER, SOLICITUDESDEM_API } from './services/solicitudesdemanda.service';
import { NotificacionesModule } from '../notificaciones/notificaciones.module';


@NgModule({
  declarations: [
    SolicitudesdemandaComponent,
  ...
  providers: [
    { provide: SOLICITUDESDEM_API, useValue: '' },
...
export class SolicitudesdemandaModule { }
